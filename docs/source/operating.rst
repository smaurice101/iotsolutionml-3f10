[iotsolutionml-3f10] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [iotsolutionml-3f10] container is NOT running**.

.. tip::
   You must have your [iotsolutionml-3f10] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=44321  \-\-env VIPERVIZPORT=37133  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:37133/iot-failure-machinelearning-seneca.html?topic=iot-preprocess,iot-ml-prediction-results-output&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:37133/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   maadsdocker/iotsolutionml-3f10-amd64 (https://hub.docker.com/r/maadsdocker/iotsolutionml-3f10-amd64)
...
.. important::
   docker run -d -p 58573:58573 -p 35925:35925 -p 42091:42091 \-\-env TSS=0 \-\-env SOLUTIONNAME=iotsolutionml-3f10 \-\-env SOLUTIONDAG=solution_preprocessing_ml_dag-iotsolutionml-3f10 \-\-env GITUSERNAME=smaurice101  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=58573  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=35925  \-\-env SOLUTIONVIPERVIZPORT=42091 \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env EXTERNALPORT=44321 \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env VIPERVIZPORT=37133 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  maadsdocker/iotsolutionml-3f10-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=42091
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=58573
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - maadsdocker/iotsolutionml-3f10-amd64
...
It can be accessed by entering: http://localhost:35925
...
.. important::
   http://localhost:42091/iot-failure-machinelearning-seneca.html?topic=iot-preprocess,iot-ml-prediction-results-output&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:42091/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:42091/<html file>
...
[iotsolutionml-3f10] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/iotsolutionml-3f10
...
.. important::
   https://iotsolutionml-3f10.readthedocs.io
...
.. important::
   solution_preprocessing_ml_dag-iotsolutionml-3f10
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=58573, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=35277, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=38431, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=38357, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=35615, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=38105, HPDEHOST=127.0.1.1, HPDEPORT=37995, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=37899

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-3125-iotsolutionml-3f10,solution_preprocessing_ml_dag-iotsolutionml-3f10, python-preprocess-82-iotsolutionml-3f10,solution_preprocessing_ml_dag-iotsolutionml-3f10, python-preprocess2-9146-iotsolutionml-3f10,solution_preprocessing_ml_dag-iotsolutionml-3f10, python-ml-1560-iotsolutionml-3f10,solution_preprocessing_ml_dag-iotsolutionml-3f10, python-predict-6051-iotsolutionml-3f10,solution_preprocessing_ml_dag-iotsolutionml-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
